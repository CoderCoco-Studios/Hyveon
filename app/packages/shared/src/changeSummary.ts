 ...
 * (confirmed against `node_modules/@pulumi/pulumi/automation/stack.d.ts` at
 * authoring time): `@hyveon/shared` is consumed by the Lambda packages and
 * the web renderer, neither of which has any other reason to depend on the
 * (Node-only, Electron-bundled-as-`external`) `@pulumi/pulumi` package.
 */
