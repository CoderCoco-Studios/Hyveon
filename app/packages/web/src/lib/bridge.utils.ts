...
/**
 * Shorter wording of {@link BRIDGE_UNAVAILABLE} used by `settings.page.tsx`'s IPC-rejection paths;
 * kept distinct rather than reworded to avoid an unreviewed user-facing string change.
 */
