...
import { SnowflakeChipsInput } from './snowflake-chips-input.component.js';
...
export function DeploymentSettingsForm() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="space-y-2">
          <Label htmlFor="settings-base-allowed-guilds">Base allowed guild IDs</Label>
          <SnowflakeChipsInput
        ...
        <div className="space-y-2">
          <Label htmlFor="settings-base-admin-user-ids">Base admin user IDs</Label>
          <SnowflakeChipsInput
        ...
        <div className="space-y-2">
          <Label htmlFor="settings-base-admin-role-ids">Base admin role IDs</Label>
          <SnowflakeChipsInput
