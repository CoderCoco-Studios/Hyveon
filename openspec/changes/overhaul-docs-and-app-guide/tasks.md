...
- [x] 2.7 Add capture cases for the terraform page in its pre-run and awaiting-approval states, plus the run-history list. (Streamed log output was initially uncapturable; group 7 fixed the underlying bridge defect and 7.12 re-captured these with real streamed output.)
