...
Whenever any game in the deployment has `https: true`, every game —
including a non-HTTPS game, and regardless of that port's declared
`visibility` — SHALL NOT declare container port 443 or 80 with protocol
`tcp`. This closes an
