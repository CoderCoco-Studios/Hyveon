# install-and-signing-docs Specification

## Purpose
Defines the documentation covering how to install the unsigned MVP builds
on each supported OS, and the roadmap for reaching signed releases so
auto-update can eventually be enabled by default.
