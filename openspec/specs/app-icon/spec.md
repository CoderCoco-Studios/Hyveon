...
## Purpose
Defines the Hyveon app icon asset set and its wiring through electron-builder
and the web renderer, so the packaged installers, running app, and dev
preview all show Hyveon branding instead of Electron/browser defaults.
