...
Hard limit: 50 ≤ character count ≤ 1000 (OpenSpec's zod schema validates this)
...
For behavior changes with a clear before/after, use the From/To format
...
Repeat this block for multiple changes; pure additions or removals can use a
simple list.
-->
...
Naming rules: see openspec/specs/README.md — use a compound noun (at least
2 words), e.g. `user-auth`, `data-export`, `api-rate-limiting`; don't use a
single word.
